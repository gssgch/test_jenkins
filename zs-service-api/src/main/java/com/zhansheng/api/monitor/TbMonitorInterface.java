...
@Api(value = "叶根螺栓监控预测接口", description = "叶根螺栓预测接口，提供查询方法")
public interface TbMonitorInterface {
    ...
    @ApiOperation("叶根螺栓整体状况趋势图(新 多条件查询!)")
    @ApiImplicitParams({
