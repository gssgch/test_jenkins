...
public class MP3ToWavUtil {
    ...
    public static boolean byteToWav(byte[] sourceBytes, String targetPath) {
        ...
        try (final ByteArrayInputStream bais = new ByteArrayInputStream(sourceBytes);
            ...
            // 设置百度语音识别的音频格式
            AudioFormat pcmFormat = new AudioFormat(AudioFormat.Encoding.PCM_SIGNED, 16000,
                    16, 1, 2, 16000, false);
            try (
    ...
    public static String toString(FSDataInputStream inputStream) throws Exception{
